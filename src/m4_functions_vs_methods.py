...
def try_methods():
    ...
    ###########################################################################
    tryguy = rg.SimpleTurtle()
    tryguy.pen = rg.Pen('brown', 5)
    tryguy.forward(150)
    tryguy.left(90)
    tryguy.forward(50)
    tryguy.backward(100)
...
def try_functions():
    ...
    ###########################################################################
    hop = rg.SimpleTurtle()
    hop.go_to(rg.Point(200, 100))
    hop.go_to(rg.Point(300, 30))

    leap = rg.SimpleTurtle()
    leap.go_to(rg.Point(100, 200))
    leap.go_to(rg.Point(0, 0))

    bound = rg.SimpleTurtle()
    bound.go_to(rg.Point(-50, 50))
    bound.go_to(rg.Point(100, 100))

# that was first attempt. Upon review, here is the second attempt
...
def try_methods_and_functions():
    ...
    ###########################################################################
    newguy = rg.SimpleTurtle()
    newguy.pen = rg.Pen('blue', 5)

    newguy.backward(150)

    newguy.speed = 1
    draw_many_squares(newguy, 2, 100, 30)

    newguy.speed = 5
    newguy.pen = rg.Pen('red', 5)
    draw_many_squares(newguy, 10, 50, 15)

    newguy.speed = 100
    newguy.pen = rg.Pen('red', 35)
    draw_many_squares(newguy, 8, 300, 60)

    newguy.pen = rg.Pen('black', 3)

    newguy.backward(200)

    newguy.draw_circle(30)

    newguy.draw_square(50)
